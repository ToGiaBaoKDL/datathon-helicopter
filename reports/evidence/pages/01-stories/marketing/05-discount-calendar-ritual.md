...
The margin crisis is not caused by discounting — it is caused by <Value data={negative_by_category} column=negative_skus fmt=0/> <a href="/01-stories/product/02-profitability-leak">negative-margin SKUs</a>, mostly in Streetwear. 
