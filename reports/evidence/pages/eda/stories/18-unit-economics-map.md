...
The gap is significant: direct customers are nearly <b><Value data={retention_ratio} column=ratio fmt=0.0x/></b> as likely to return within the first month as organic search customers.
</Alert>
