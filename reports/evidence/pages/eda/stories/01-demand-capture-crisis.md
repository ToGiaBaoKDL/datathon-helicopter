...
<LineChart
    ...
    yFmt="pct2"
>
    <ReferenceLine y=0.0117 label="Peak 1.17%" hideValue=true color=positive lineType=dashed/>
    <ReferenceLine y=0.0031 label="Trough 0.31%" hideValue=true color=negative lineType=dashed/>
</LineChart>
...
<BarChart
    ...
    yFmt="pct2"
>
    <ReferenceLine y=0.0117 label="Peak" hideValue=true color=positive lineType=dashed/>
</BarChart>
