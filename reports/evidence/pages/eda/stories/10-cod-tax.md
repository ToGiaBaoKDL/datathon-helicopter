...
<b>The question:</b> COD (Cash on Delivery) accounts for a large order share but cancels at roughly <b><Value data={cod_cancel_ratio} column=ratio fmt=0.0x/></b> the prepaid rate. 
...
<Alert status="info">
COD represents a large share of orders. But the cancellation rate is <b><Value data={cod_rate} column=cod_cancel_rate fmt=pct2/></b> vs <b><Value data={prepaid_rate} column=prepaid_cancel_rate fmt=pct2/></b> for prepaid — a <b><Value data={cod_cancel_ratio} column=ratio fmt=0.0x/></b> gap. 
...
<b>Action:</b> COD cancellation is <b><Value data={cod_cancel_ratio} column=ratio fmt=0.0x/></b> prepaid — a structural tax. 
