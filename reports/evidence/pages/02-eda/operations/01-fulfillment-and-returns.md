...
<DataTable data={fulfillment_daily} rows=10>
    ...
    <Column id=shipped_order_count title="Shipped" fmt=0/>
    <Column id=avg_days_to_ship title="Days to Ship" fmt=0.0/>
    <Column id=avg_days_in_transit title="Transit Days" fmt=0.0/>
...
<DataTable data={returns_daily} rows=10>
    <Column id=sales_date title="Date"/>
    <Column id=return_record_rate title="Return Record Rate" fmt=pct2/>
    <Column id=return_unit_rate title="Return Unit Rate" fmt=pct2/>
    <Column id=refund_amount title="Refund" fmt=num0/>
    <Column id=defective_return_count title="Defective" fmt=0/>
    <Column id=wrong_size_return_count title="Wrong Size" fmt=0/>
    <Column id=late_delivery_return_count title="Late Delivery" fmt=0/>
</DataTable>

## Related Stories

- [Quality Before Growth](/01-stories/product/03-quality-before-growth)
- [04 Shipment Blind Spot](/01-stories/operations/04-shipment-blind-spot)
