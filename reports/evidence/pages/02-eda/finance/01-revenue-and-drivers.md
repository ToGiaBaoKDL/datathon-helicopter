...
<DataTable data={anomaly_summary} rows=10>
    ...
    <Column id=anomaly_flag title="Flag"/>
</DataTable>
...
<Alert status="info">
The calendar heatmap below reveals daily revenue intensity across the selected period.
Bright clusters highlight peak trading days; dark stretches reveal troughs.
Use this to spot anomaly days, promotional impact, and seasonal clustering at a glance.
</Alert>
...
<DataTable data={daily_series} rows=10>
    ...
    <Column id=total_discount_amount title="Discount" fmt=num0/>
    <Column id=return_units title="Returns" fmt=0/>
    <Column id=avg_bounce_rate title="Bounce Rate" fmt=pct2/>
</DataTable>

## Related Stories

- [Revenue Anatomy](/01-stories/finance/01-revenue-anatomy)
