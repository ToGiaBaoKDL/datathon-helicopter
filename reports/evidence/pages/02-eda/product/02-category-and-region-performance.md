...
<DataTable data={category_segment_detail} rows=10>
    <Column id=month_start_date title="Month"/>
    <Column id=category title="Category"/>
    <Column id=segment title="Segment"/>
    <Column id=gross_revenue title="Revenue" fmt=num0/>
    <Column id=gross_profit title="Profit" fmt=num0/>
    <Column id=gross_margin_rate title="Margin" fmt=pct2/>
    <Column id=cancelled_revenue_share title="Cancel Share" fmt=pct2/>
...
<DataTable data={region_weekly} rows=10>
    ...
    <Column id=gross_profit title="Profit" fmt=num0/>
    <Column id=gross_margin_rate title="Margin" fmt=pct2/>
    <Column id=active_customer_count title="Active Customers" fmt=0/>
    <Column id=order_count title="Orders" fmt=0/>
    <Column id=return_units title="Returns" fmt=0/>
    <Column id=refund_amount title="Refunds" fmt=num0/>
</DataTable>

## Related Stories

- [04 Portfolio Drift](/01-stories/product/04-portfolio-drift)
