...
<DataTable data={risk_flags} rows=10>
    ...
    <Column id=stockout_risk_flag title="Stockout" fmt=0/>
    <Column id=return_spike_flag title="Return Spike" fmt=0/>
    <Column id=conversion_drop_flag title="Conv Drop" fmt=0/>
</DataTable>

## Related Stories

- [Risk Flag Convergence](/01-stories/operations/03-risk-flag-convergence)
